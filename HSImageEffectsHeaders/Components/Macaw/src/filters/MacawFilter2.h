...
#ifndef _MACAW_FILTER_2_H_
#define _MACAW_FILTER_2_H_

#include "MacawFilter.h"

namespace macaw {

class MacawFilter2 : public MacawFilter {
public:
	MacawFilter2();
	MacawFilter2(const std::string& fs);
	MacawFilter2(const std::string& fs, const std::string& vs);
	virtual ~MacawFilter2();
