...
#ifndef _MACAW_FILTER_3_H_
#define _MACAW_FILTER_3_H_

#include "MacawFilter.h"

namespace macaw {

class MacawFilter3 : public MacawFilter {
public:
	MacawFilter3();
	MacawFilter3(const std::string& fs);
	MacawFilter3(const std::string& fs, const std::string& vs);
	virtual ~MacawFilter3();
