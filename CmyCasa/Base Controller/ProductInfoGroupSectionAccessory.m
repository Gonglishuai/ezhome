//
//  ProductInfoGroupSectionAccessory.m
//  Homestyler
//
...
@implementation ProductInfoGroupSectionAccessory
...
{
    ProductInfoGroupSectionAccessory *ret = [[ProductInfoGroupSectionAccessory alloc] initWithFrame:CGRectMake(0, 0, 15.0, 15.0)] ;
