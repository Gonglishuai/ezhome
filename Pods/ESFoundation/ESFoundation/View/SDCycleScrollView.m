...
@property (nonatomic, weak) JRPageControl *pageControl;
...
//        JRPageControl *pageContol = (JRPageControl *)_pageControl;
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        {
            JRPageControl *pageControl = [[JRPageControl alloc] init];
            pageControl.alpha = 0.8;
            pageControl.currentColor = [UIColor whiteColor];
            pageControl.otherColour = [UIColor grayColor];
...
- (void)layoutSubviews
{
    ...
    self.pageControl.frame = CGRectMake(0, CGRectGetHeight(self.mainView.frame) - 9, SCREEN_WIDTH, 9);
