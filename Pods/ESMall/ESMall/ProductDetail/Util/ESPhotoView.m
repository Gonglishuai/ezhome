...
- (void)showImage
{
    ...
    { // 首次显示
        ...
        {
            __unsafe_unretained ESPhotoView *photoView = self;
            __unsafe_unretained ESPhoto *photo = _photo;
