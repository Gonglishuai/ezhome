...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _midLineV = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2, 0, 1, CELLHEIGHT*MAXROWCOUNT)];
        _midLineV.backgroundColor = [UIColor stec_lineGrayColor];
...
- (UITableView *)leftTableView
{
    if (!_leftTableView) {
        ...
        _leftTableView.separatorColor = [UIColor stec_lineGrayColor];
...
- (UITableView *)rightTableView
{
    if (!_rightTableView) {
        ...
        _rightTableView.separatorColor = [UIColor stec_lineGrayColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == _leftTableView) {
        ...
        cell.textLabel.highlightedTextColor = [UIColor stec_titleTextColor];//[UIColor stec_blueTextColor];
...
//    lineV.backgroundColor = [UIColor stec_blueTextColor];
...
//    cell.selectedBackgroundView = selectView;
    ...
    cell.textLabel.textColor = [UIColor stec_titleTextColor];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == _leftTableView && _leftArray.count > 0) {
        ...
        // 当前选中加粗
        cell.textLabel.font = [UIFont stec_titleFount];
        ...
        if (self.leftLastSelectedIndexPath) {
            ...
            // 上一次选中 加粗效果取消
            lastSelectedcell.textLabel.font = [UIFont stec_titleFount];
        }
...
- (void)showConditionTableView
{
    ...
    if (_leftArray.count == 0) {  // 一级菜单
        ...
        _rightTableView.frame = CGRectMake( 0, 0, SCREEN_WIDTH, perfectHeight);
        self.midLineV.hidden = YES;
        
    } else {  // 二级菜单
        _leftTableView.hidden = NO;
        _leftTableView.cf_height = perfectHeight;
        _rightTableView.frame = CGRectMake(SCREEN_WIDTH / 2, 0, SCREEN_WIDTH / 2, perfectHeight);
