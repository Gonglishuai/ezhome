//
//  ESRecommendOrderViewController.m
//  Consumer
//
...
@interface ESRecommendOrderViewController ()<UIScrollViewDelegate, SHSegmentedControlDelegate>
...
@implementation ESRecommendOrderViewController
...
- (void)tapOnRightButton:(id)sender {
    ESRecommendOrderSearchViewController *recommendSearchViewCon = [[ESRecommendOrderSearchViewController alloc] init];
    [self.navigationController pushViewController:recommendSearchViewCon animated:YES];
}

- (void)setChildrenControllers {
    for (NSInteger i = 0; i < 3; i++) {
        ESRecommendOrderListViewController *orderListViewCon = [[ESRecommendOrderListViewController alloc] init];
        NSString *orderType = @"";
        if (1 == i) {
            orderType = @"10";
        } else if (2 == i) {
        ...
        [orderListViewCon setType:orderType];
        [self addChildViewController:orderListViewCon];
    }
    ESRecommendReturnOrderViewController *returnOrderListViewCon = [[ESRecommendReturnOrderViewController alloc] init];
