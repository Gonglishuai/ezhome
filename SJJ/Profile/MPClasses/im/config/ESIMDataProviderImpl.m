...
@interface ESIMKitDataRequest : NSObject
...
@implementation ESIMKitDataRequest{
...
@interface ESIMDataProviderImpl()<NIMUserManagerDelegate,NIMTeamManagerDelegate,NIMLoginManagerDelegate>

@property (nonatomic,strong) UIImage *defaultUserAvatar;

@property (nonatomic,strong) UIImage *defaultTeamAvatar;

@property (nonatomic,strong) ESIMKitDataRequest *request;

@end


@implementation ESIMDataProviderImpl

- (instancetype)init{
    self = [super init];
    if (self) {
        _request = [[ESIMKitDataRequest alloc] init];
...
- (UIImage *)defaultUserAvatar
{
    ...
    {
        _defaultUserAvatar = [UIImage imageNamed:@"im_default"];
    }
